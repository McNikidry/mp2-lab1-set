...
private:
	...
	int  MemLen; // к-во эл-тов Мем для представления бит.поля
				 /*
				 MemLen – это число элементов в
				 динамическом массиве, который будет выделяться для хранения битового поля
				 */
				 // методы реализации
	unsigned int constanta = 8 * sizeof(TELEM);//Константа для разных систем, иначе будут ошибки 
	int deg;//для степени
